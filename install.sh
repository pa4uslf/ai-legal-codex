...
echo ""
echo -e "  ${CYAN}/legal review <file>${NC}            Full contract review (5 review lenses)"
...
echo -e "  ${YELLOW}Note:${NC} In Codex, you can also ask naturally, e.g. ${CYAN}review this contract for risks${NC}."
echo ""
